          ...
          watch('intended_for') === 5 && (
            <div>
              ...
              <div>
                ...
                nejvýstižněji popište, co akce přináší účastníkům, co zajímavého
                si zkusí, co se dozví, naučí, v čem se rozvinou…
              </div>
              <FormInputError>
                <textarea
              ...
              <div>
                V základu uveďte, jak bude vaše akce programově a dramaturgicky
                koncipována (motivační příběh, zaměření programu – hry, diskuse,
                řemesla,...). Uveďte, jak náplň a program akce reflektují
                potřeby vaší cílové skupiny prvoúčastníků.
              </div>
              <FormInputError>
                <textarea
